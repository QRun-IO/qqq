...
include::esb/index.adoc[leveloffset=+1]

=== API server (OpenAPI)

See the {qqq-tree-url}/qqq-middleware-javalin/src/main/java/com/kingsrook/qqq/middleware/javalin/specs[endpoint specification API] and the https://www.qrun.io/docs[hosted framework documentation]. Endpoint tags are optional.
...
include::actions/CountAction.adoc[leveloffset=+1]

include::actions/AggregateAction.adoc[leveloffset=+1]

include::actions/InsertAction.adoc[leveloffset=+1]

include::actions/UpdateAction.adoc[leveloffset=+1]

include::actions/DeleteAction.adoc[leveloffset=+1]

include::actions/ReplaceAction.adoc[leveloffset=+1]
