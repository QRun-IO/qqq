...
/*******************************************************************************
 * RDBMS adapter for the {@link StringLengthFunction} that generates a
 * {@code CHAR_LENGTH(col)} SQL expression.
 *
 *******************************************************************************/
public class RDBMSStringLengthFunction implements RDBMSFieldFunctionAdapterInterface
{
   ...
   public String wrapColumnName(String escapedColumnName, FieldFunction fieldFunction, Function<String, String> fieldNameToColumnReference)
   {
      ...
      ///////////////////////////////////////////////////////////////////
      return "CHAR_LENGTH(" + escapedColumnName + ")";
   }
