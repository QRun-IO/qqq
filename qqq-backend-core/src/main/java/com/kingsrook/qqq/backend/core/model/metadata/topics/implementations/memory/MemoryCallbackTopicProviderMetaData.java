...
import com.kingsrook.qqq.backend.core.modules.topics.implementations.memory.MemoryCallbackTopicProvider;


/*******************************************************************************
 * Implementation of a topic-provider that runs purely in-memory - and uses
 * real-time callbacks for message delivery.
 *
 ...
 * </ul>
 *******************************************************************************/
public class MemoryCallbackTopicProviderMetaData extends QTopicProviderMetaData
{

   static
   {
      QTopicProviderDispatcher.registerTopicProvider(new MemoryCallbackTopicProvider());
   }
    ...
    **
    *******************************************************************************/
   public MemoryCallbackTopicProviderMetaData()
   {
      super();
      setType(TopicType.IN_MEMORY_CALLBACK);
   }
    ...
    ***************************************************************************/
   @Override
   public MemoryCallbackTopicProviderMetaData withName(String name)
   {
      super.withName(name);
      return (this);
   }
