...
/*******************************************************************************
 ** Unit test for MongoDBTableBackendDetails 
 *******************************************************************************/
class MongoDBTableBackendDetailsTest extends BaseTest
{
   ...
   void testClone()
   {
      MongoDBTableBackendDetails tableBackendDetails = (MongoDBTableBackendDetails) new MongoDBTableBackendDetails()
         .withTableName("originalTableName")
         .withBackendType("originalBackendType");

      MongoDBTableBackendDetails clone = (MongoDBTableBackendDetails) tableBackendDetails.clone();
