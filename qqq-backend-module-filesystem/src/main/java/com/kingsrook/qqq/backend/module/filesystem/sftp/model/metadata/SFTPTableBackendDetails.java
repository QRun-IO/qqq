...
public class SFTPTableBackendDetails extends AbstractFilesystemTableBackendDetails
{
    ...
    ***************************************************************************/
   @Override
   protected SFTPTableBackendDetails finishFilesystemSubclassClone(QTableBackendDetails cloned)
   {
      return ((SFTPTableBackendDetails) super.finishFilesystemSubclassClone(cloned));
   }
