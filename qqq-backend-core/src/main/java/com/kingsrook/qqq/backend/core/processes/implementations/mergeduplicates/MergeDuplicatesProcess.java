...
public class MergeDuplicatesProcess
{
   ...
   public static class Builder extends StreamedETLWithFrontendProcess.Builder
   {
      ...
      public Builder withMergeDuplicatesTransformStepClass(Class<? extends AbstractMergeDuplicatesTransformStep> transformStepClass)
      {
         ...
         AbstractMergeDuplicatesTransformStep.MergeProcessConfig config;

         try
         {
            AbstractMergeDuplicatesTransformStep transformStep = transformStepClass.getConstructor().newInstance();
            config = transformStep.getMergeProcessConfig();
         }
         catch(Exception e)
         {
         ...
         setInputFieldDefaultValue(StreamedETLWithFrontendProcess.FIELD_SOURCE_TABLE, config.tableName());
         setInputFieldDefaultValue(StreamedETLWithFrontendProcess.FIELD_DESTINATION_TABLE, config.tableName());
         return (this);
      }
