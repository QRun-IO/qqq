...
** Capability flags control the operations exposed in frontend metadata. Direct table HTTP operations do not enforce these flags; use `permissionRules` to deny access. New runtime capability enforcement is deferred in https://github.com/QRun-IO/qqq/issues/546[issue #546].
