 ...
 *******************************************************************************/
public interface ProcessedAuditHandlerInterface extends AuditHandlerInterface
{

   /***************************************************************************
    ** Handle processed audit events.
    **
    ** @param input contains the list of AuditSingleInput objects
    ** @throws QException if processing fails
    ***************************************************************************/
   void handleAudit(ProcessedAuditHandlerInput input) throws QException;
