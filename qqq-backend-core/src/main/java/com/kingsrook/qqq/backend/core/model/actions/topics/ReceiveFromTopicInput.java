...
/*******************************************************************************
 * Input wrapper for the interface to receive from a topic
 ...
 * default).
 *******************************************************************************/
public class ReceiveFromTopicInput extends AbstractActionInput
{
   ...
   /***************************************************************************
    * fluently add a single topic message to this action input.
    ***************************************************************************/
   public ReceiveFromTopicInput withMessage(TopicMessage topicMessage)
   {
    ...
    * @return this
    *******************************************************************************/
   public ReceiveFromTopicInput withTopicMessageList(List<TopicMessage> topicMessageList)
   {
      this.topicMessageList = topicMessageList;
      return (this);
   }
