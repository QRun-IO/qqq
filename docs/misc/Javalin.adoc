...
The 4.0 migration candidate uses Java 21, Javalin 7.2.3 and Jetty 12.1.13. The Javalin 7 configuration examples below target that candidate; QQQ 4.0 publication remains pending.
