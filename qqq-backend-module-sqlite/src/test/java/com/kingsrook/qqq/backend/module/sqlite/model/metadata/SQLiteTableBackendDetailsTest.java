...
/*******************************************************************************
 ** Unit test for SQLiteTableBackendDetails 
 *******************************************************************************/
class SQLiteTableBackendDetailsTest extends BaseTest
{
   ...
   void test()
   {
      SQLiteTableBackendDetails tableBackendDetails = (SQLiteTableBackendDetails) new SQLiteTableBackendDetails()
         .withTableName("originalTableName")
         .withBackendType("originalBackendType");

      SQLiteTableBackendDetails clone = (SQLiteTableBackendDetails) tableBackendDetails.clone();
